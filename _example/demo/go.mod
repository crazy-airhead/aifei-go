...
require (
	...
	github.com/crazy-airhead/aifei-go/db v0.0.12
...
require (
	github.com/crazy-airhead/aifei-go/enjoy v0.0.12 // indirect
	github.com/crazy-airhead/aifei-go/go-http v0.0.12 // indirect
