...
require (
	github.com/crazy-airhead/aifei-go/aifei v0.0.12 // indirect
	github.com/crazy-airhead/aifei-go/config v0.0.12 // indirect
	github.com/crazy-airhead/aifei-go/log v0.0.12 // indirect
