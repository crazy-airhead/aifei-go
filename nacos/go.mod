...
require (
	github.com/crazy-airhead/aifei-go/aifei v0.0.9
	github.com/crazy-airhead/aifei-go/config v0.0.9
	github.com/crazy-airhead/aifei-go/log v0.0.9
	github.com/crazy-airhead/aifei-go/nami v0.0.9
