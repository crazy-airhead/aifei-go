...
require (
	...
	github.com/crazy-airhead/aifei-go/flow v0.1.1
	github.com/crazy-airhead/aifei-go/plugins/flow v0.1.1
)

require (
	github.com/crazy-airhead/aifei-go/aifei v0.1.1 // indirect
	github.com/crazy-airhead/aifei-go/dami v0.1.1 // indirect
