...
require (
	github.com/crazy-airhead/aifei-go/aifei v0.0.45
	github.com/crazy-airhead/aifei-go/config v0.0.45
	github.com/crazy-airhead/aifei-go/db v0.0.45
	github.com/crazy-airhead/aifei-go/http v0.0.45
	github.com/crazy-airhead/aifei-go/plugins/dataisolate v0.0.45
	github.com/crazy-airhead/aifei-go/server v0.0.45
