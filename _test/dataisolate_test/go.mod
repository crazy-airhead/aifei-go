...
require (
	github.com/crazy-airhead/aifei-go/aifei v0.1.1
	github.com/crazy-airhead/aifei-go/config v0.1.1
	github.com/crazy-airhead/aifei-go/db v0.1.1
	github.com/crazy-airhead/aifei-go/http v0.1.1
	github.com/crazy-airhead/aifei-go/plugins/dataisolate v0.1.1
	github.com/crazy-airhead/aifei-go/server v0.1.1
	modernc.org/sqlite v1.54.0
)

require (
	github.com/ajitpratap0/GoSQLX v1.14.0 // indirect
	github.com/crazy-airhead/aifei-go/enjoy v0.1.1 // indirect
