...
require github.com/crazy-airhead/aifei-go/plugins/nacos v0.0.43
...
require (
	...
	github.com/crazy-airhead/aifei-go/config v0.0.43 // indirect
	github.com/crazy-airhead/aifei-go/log v0.0.43 // indirect
	github.com/crazy-airhead/aifei-go/nami v0.0.43 // indirect
