...
require github.com/crazy-airhead/aifei-go/plugins/nacos v1.0.0
...
require (
	...
	github.com/crazy-airhead/aifei-go/config v1.0.0 // indirect
	github.com/crazy-airhead/aifei-go/log v1.0.0 // indirect
	github.com/crazy-airhead/aifei-go/nami v1.0.0 // indirect
