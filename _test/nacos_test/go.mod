...
require github.com/crazy-airhead/aifei-go/plugins/nacos v0.1.0
...
require (
	...
	github.com/crazy-airhead/aifei-go/config v0.1.0 // indirect
	github.com/crazy-airhead/aifei-go/log v0.1.0 // indirect
	github.com/crazy-airhead/aifei-go/nami v0.1.0 // indirect
