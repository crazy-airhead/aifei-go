...
require (
	github.com/crazy-airhead/aifei-go/db v0.0.39 // indirect
	github.com/crazy-airhead/aifei-go/enjoy v0.0.39 // indirect
	github.com/crazy-airhead/aifei-go/http v0.0.39 // indirect
