...
import (
	...
	jsoncoder "github.com/crazy-airhead/aifei-go/nami/coder/json"
)
...
func TestGetSuccess(t *testing.T) {
	...
	rst, err := newClient(t, http.New()).Action(nami.MethodGet).URL(srv.URL).CallOrThrow(nil, nil, nil)
	if err != nil {
...
func TestPostJSONBody(t *testing.T) {
	...
	var out resp
	err := newClient(t, http.New()).Action(nami.MethodPost).URL(srv.URL).
...
func TestGetWithQueryAndHeaders(t *testing.T) {
	...
	rst, err := newClient(t, http.New()).Action(nami.MethodGet).URL(srv.URL).
