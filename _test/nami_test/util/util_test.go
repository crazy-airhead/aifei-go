...
import (
	...
	util "github.com/crazy-airhead/aifei-go/nami/util"
)
...
func TestGet_Non2xx(t *testing.T) {
	...
	if _, err := util.Get(srv.URL); err == nil {
...
func TestGetResult_TransportError(t *testing.T) {
	if _, err := util.GetResult("http://127.0.0.1:0/nope"); err == nil {
...
func TestGetResultWith(t *testing.T) {
	...
	r, err := util.GetResultWith(srv.URL,
...
func TestGetJSON_Success(t *testing.T) {
	...
	v, err := util.GetJSON[resp](srv.URL)
	if err != nil {
...
func TestGetJSON_Slice(t *testing.T) {
	...
	items, err := util.GetJSON[[]item](srv.URL)
	if err != nil {
...
func TestGetJSON_Non2xx(t *testing.T) {
	...
	if _, err := util.GetJSON[any](srv.URL); err == nil {
...
func TestGetJSONWith(t *testing.T) {
	...
	v, err := util.GetJSONWith[resp](srv.URL,
...
func TestGetWith_Params(t *testing.T) {
	...
	body, err := util.GetWith(srv.URL, map[string]string{"page": "3", "size": "15"}, nil)
	if err != nil {
...
func TestGetWith_Headers(t *testing.T) {
	...
	body, err := util.GetWith(srv.URL, nil, map[string]string{"Authorization": "Bearer xyz"})
	if err != nil {
		t.Fatalf("GetWith: %v", err)
	}
	if body != "ok" {
...
func TestGetWith_BothNil(t *testing.T) {
	...
	body, err := util.GetWith(srv.URL, nil, nil)
	if err != nil {
...
func TestGetBind_Success(t *testing.T) {
	...
	var v resp
	if err := util.GetBind(srv.URL, nil, &v); err != nil {
...
func TestGetBindWith(t *testing.T) {
	...
	var v resp
	err := util.GetBindWith(srv.URL, nil,
...
func TestPost_WithBody(t *testing.T) {
	...
	body, err := util.Post(srv.URL, payload{Key: "val"})
	if err != nil {
		t.Fatalf("Post: %v", err)
	}
...
func TestPost_NilBody(t *testing.T) {
	...
	body, err := util.Post(srv.URL, nil)
	if err != nil {
...
func TestPost_Non2xx(t *testing.T) {
	...
	if _, err := util.Post(srv.URL, nil); err == nil {
...
func TestPostResult(t *testing.T) {
	...
	r, err := util.PostResult(srv.URL, nil)
	if err != nil {
...
func TestPostResultWith(t *testing.T) {
	...
	r, err := util.PostResultWith(srv.URL,
...
func TestPostWith_Nils(t *testing.T) {
	...
	r, err := util.PostWith(srv.URL, nil, nil, nil)
	if err != nil {
...
func TestPostBind(t *testing.T) {
	...
	var v resp
	if err := util.PostBind(srv.URL, map[string]string{"name": "x"}, &v); err != nil {
...
func TestPostBind_Non2xx(t *testing.T) {
	...
	var v any
	if err := util.PostBind(srv.URL, nil, &v); err == nil {
...
func TestPostJSON(t *testing.T) {
	...
	v, err := util.PostJSON[resp](srv.URL, map[string]string{"name": "x"})
	if err != nil {
...
func TestPostJSON_Non2xx(t *testing.T) {
	...
	if _, err := util.PostJSON[any](srv.URL, nil); err == nil {
		t.Fatal("expected error for 409")
	}
}
...
func TestPostJSONWith(t *testing.T) {
	...
	v, err := util.PostJSONWith[resp](srv.URL,
		map[string]string{"user": "me"},
		map[string]string{"op": "login"},
		map[string]string{"X-Device": "mobile"},
	)
...
func TestRequest_String(t *testing.T) {
	...
	body, err := util.Request(http.MethodPut, srv.URL, nil, nil, nil)
	if err != nil {
...
func TestRequest_Non2xx(t *testing.T) {
	...
	if _, err := util.Request(http.MethodGet, srv.URL, nil, nil, nil); err == nil {
		t.Fatal("expected error for 404")
	}
}
...
func TestRequestResult(t *testing.T) {
	...
	r, err := util.RequestResult(http.MethodDelete, srv.URL, nil, nil, nil)
	if err != nil {
...
func TestRequestResult_Params(t *testing.T) {
	...
	r, err := util.RequestResult(http.MethodDelete, srv.URL,
...
func TestRequestResult_Headers(t *testing.T) {
	...
	r, err := util.RequestResult(http.MethodGet, srv.URL, nil, nil, map[string]string{"X-Auth": "token"})
	if err != nil {
...
func TestRequestBind(t *testing.T) {
	...
	var v resp
	if err := util.RequestBind(http.MethodPatch, srv.URL, nil, nil, nil, &v); err != nil {
...
func TestRequestBind_Non2xx(t *testing.T) {
	...
	var v any
	if err := util.RequestBind(http.MethodGet, srv.URL, nil, nil, nil, &v); err == nil {
...
func TestRequestJSON(t *testing.T) {
	...
	v, err := util.RequestJSON[resp](http.MethodPatch, srv.URL, nil, nil, nil)
	if err != nil {
...
func TestRequestJSON_Non2xx(t *testing.T) {
	...
	if _, err := util.RequestJSON[any](http.MethodGet, srv.URL, nil, nil, nil); err == nil {
		t.Fatal("expected error for 403")
	}
}
...
func TestSetBaseURL(t *testing.T) {
	...
	util.SetBaseURL(srv.URL)
	defer util.SetBaseURL("")

	body, err := util.Get("/api/v1/users")
	if err != nil {
...
func TestSetBaseURL_FullURLBypasses(t *testing.T) {
	...
	util.SetBaseURL("http://other.example.com")
	defer util.SetBaseURL("")
...
func TestSetBaseURL_PostWithPath(t *testing.T) {
	...
	body, err := util.Post("/api/orders", map[string]string{"item": "book"})
	if err != nil {
...
func TestBaseURL(t *testing.T) {
	old := util.BaseURL()
	util.SetBaseURL("http://example.com/api")
	if util.BaseURL() != "http://example.com/api" {
		t.Fatalf("got %q", util.BaseURL())
	}
	util.SetBaseURL(old)
}
